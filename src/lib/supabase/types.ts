...
//   $function$
//   
// FUNCTION cleanup_selected_duplicates(text[])
...
//   CREATE OR REPLACE FUNCTION public.get_inventory_data(p_session_id integer, p_funcionario_id integer DEFAULT NULL::integer)
//    RETURNS TABLE(id bigint, codigo_barras text, codigo_produto bigint, mercadoria text, tipo text, preco numeric, saldo_inicial numeric, saldo_final numeric, contagem numeric, entrada_estoque_carro numeric, saida_carro_estoque numeric, entrada_cliente_carro numeric, saida_carro_cliente numeric)
//    LANGUAGE plpgsql
//   AS $function$
//   BEGIN
//   RETURN QUERY
...
//   $function$
//   
// FUNCTION get_route_duplicates_detailed(integer)
//   CREATE OR REPLACE FUNCTION public.get_route_duplicates_detailed(p_rota_id integer)
//    RETURNS TABLE(id_to_delete text, pedido_id bigint, cliente_nome text, tipo_duplicidade text, detalhes text)
//    LANGUAGE plpgsql
//    SECURITY DEFINER
//   AS $function$
//   BEGIN
...
//   $function$
//   
// FUNCTION process_estoque_carro_retroactive()
...
//   $function$
//   
// FUNCTION sync_inventario_from_reposicao()
...
// Table: REPOSIÇÃO E DEVOLUÇÃO
//   trg_process_estoque_carro_retroactive: CREATE TRIGGER trg_process_estoque_carro_retroactive AFTER INSERT ON public."REPOSIÇÃO E DEVOLUÇÃO" FOR EACH ROW EXECUTE FUNCTION process_estoque_carro_retroactive()
...
//   trg_sync_inventario_from_reposicao: CREATE TRIGGER trg_sync_inventario_from_reposicao AFTER INSERT ON public."REPOSIÇÃO E DEVOLUÇÃO" FOR EACH ROW EXECUTE FUNCTION sync_inventario_from_reposicao()
// Table: ROTA_ITEMS
