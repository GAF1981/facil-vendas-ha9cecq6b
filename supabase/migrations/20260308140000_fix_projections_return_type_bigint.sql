-- Fix for error: 42804: Returned type bigint does not match expected type integer in column 1
-- Dropping the function first ensures we can recreate it with the new BIGINT return type structure
